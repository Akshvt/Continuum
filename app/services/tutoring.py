...
from app.cognee_ops import recall
...
DEFAULT_TEACHING_STYLE = "guided_recall"
...
async def _generate_question(
    ...
    if not config.LLM_API_KEY or config.LLM_PROVIDER.lower() != "openai":
            ...
            messages=[
                ...
                },
                {
                    ...
                    "content": (
                        ...
                        f"Teaching style: {DEFAULT_TEACHING_STYLE}\n"
                        f"Student recall:\n{student_context}\n\n"
